  ...
  return (
    <footer className="bg-blue-100">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <h4 className="text-center font-bold text-xl mt-3">P2P Clouds</h4>
        <p className="mx-auto mt-4 max-w-md text-center leading-relaxed text-gray-500">
          Experience the Future of Business management with P2P Clouds
          Collaboration, Innovative and Revolutionizing Product solutions for a
          seamless Digital Journey and Solutions.
        </p>
